          ...
          <>
            ...
            <fieldset className="fieldset">
              ...
              <div className="relative">
                ...
                <pre className="max-h-64 overflow-y-auto whitespace-pre-wrap break-all rounded-box bg-base-200 p-4 pr-20 font-mono text-xs">
            ...
            <fieldset className="fieldset">
              ...
              <div className="flex items-start gap-2">
                <code className="min-w-0 flex-1 whitespace-pre-wrap break-all rounded-field bg-base-200 px-3 py-2 font-mono text-xs">
                  {claudeCodeCmd}
                </code>
                <button
                  type="button"
